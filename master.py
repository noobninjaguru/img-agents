...
Manages all eight agents:
  ...
  Agent 7 — Strategist:        regime 9:25 AM + signals 9:30 AM IST weekdays
  Agent 8 — Daily Data:        4:00 PM IST weekdays
...
from agent7_strategist.regime_classifier import run_regime_weekday
from agent7_strategist.signal_fusion import run_signals_weekday
...
# Agent 7: regime 9:25 AM IST (03:55 UTC) + signals 9:30 AM IST (04:00 UTC), weekdays
# (run_regime_weekday / run_signals_weekday skip weekends internally)
schedule.every().day.at("03:55").do(run_threaded, run_regime_weekday)
schedule.every().day.at("04:00").do(run_threaded, run_signals_weekday)
...
def startup():
    ...
    print(f"  Agent 7 (Strategist):       regime 09:25 + signals 09:30 IST weekdays")
